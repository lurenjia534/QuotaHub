...
class ZhipuSubscriptionCardProjector : SubscriptionCardProjector {
    override fun project(
        ...
        return SubscriptionCardProjection(
            ...
            nextResetAt = limitResources.mapNotNull { it.zhipuWindow?.resetAtEpochMillis }.minOrNull(),
            risk = limitResources.zhipuDominantRisk()
        )
    }
}
